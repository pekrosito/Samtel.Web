...
var routes = [
    ...
    { path: 'products', component: _product_alerts_product_alerts_component__WEBPACK_IMPORTED_MODULE_3__["ProductAlertsComponent"] }
];
...
var ProductAlertsComponent = /** @class */ (function () {
    function ProductAlertsComponent(api, snackBar) {
        this.api = api;
    ...
    ProductAlertsComponent.prototype.load = function () {
        ...
        this.api.getSinVariable().subscribe(function (response) {
            ...
            _this.snackBar.open('Barra de navegación', 'Cerrar', {
                duration: 2000,
            });
